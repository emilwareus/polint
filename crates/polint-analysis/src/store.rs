...
use crate::mir_op::{MirOperation, MirOperationKind, MirValue, UnsupportedSemanticFact};
use crate::places::{PlaceFact, PlaceRoot, PlaceTypeFact};
...
mod tests {
    use super::*;
    use crate::ids::{MirBodyId, MirOpId, PlaceId, UnsupportedId};
    ...
    fn place(interner: &polint_core::StableKeyInterner) -> PlaceFact {
        PlaceFact {
            id: PlaceId(0),
            language: Language::Go,
