...
mod tests {
    ...
    use polint_core::{FileId, Language, Span, stable_key_for_test};
    ...
    fn build_db(
        summaries: Vec<crate::summaries::facts::SummaryFact>,
    ...
    fn reverse_intern_order_preserves_member_text_order() {
        let forward = polint_core::StableKeyInterner::default();
        let reverse = polint_core::StableKeyInterner::default();
