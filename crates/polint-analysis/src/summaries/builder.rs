...
impl DirectSummaryBuilder {
    pub fn build(
        ...
        let places_by_id: BTreeMap<PlaceId, &crate::places::PlaceFact> = {
...
fn build_control_effects(
    body: &MirBody,
    body_ops: &[&crate::mir_op::MirOperation],
...
fn build_memory_effects(
    body_ops: &[&crate::mir_op::MirOperation],
    places_by_id: &BTreeMap<PlaceId, &crate::places::PlaceFact>,
    has_unresolved: bool,
) -> MemoryEffects {
...
mod tests {
    ...
    fn empty_db_produces_empty_output() {
        ...
        let output =
            DirectSummaryBuilder::build(&crate::LocalAnalysisDb::new().stable_key_interner(), &db);
