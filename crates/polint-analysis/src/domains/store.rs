...
pub struct DomainStore {
    ...
    observations_by_stable_key: BTreeMap<polint_core::StableKeyId, usize>,
    events_by_body: BTreeMap<MirBodyId, Vec<usize>>,
    events_by_status: BTreeMap<DomainStatus, Vec<usize>>,
    events_by_stable_key: BTreeMap<polint_core::StableKeyId, usize>,
}

impl DomainStore {
    pub fn from_output(output: DomainOutput, interner: &polint_core::StableKeyInterner) -> Self {
...
mod tests {
    ...
    use crate::cfg::ids::BasicBlockId;
    use crate::domains::core::ConstantLiteral;
