...
use crate::cfg::facts::{BasicBlockFact, CfgEdgeKind, CfgNodeFact};
use crate::cfg::ids::{BasicBlockId, CfgFunctionId, CfgNodeId};
use crate::ids::{CallSiteId, MirBodyId, MirOpId, PlaceId};
use crate::ifds::{Icfg, IcfgEdgeKind};
...
struct SolverFactIndex<'a> {
    ...
    functions: Vec<&'a crate::cfg::facts::CfgFunctionFact>,
    function_by_cfg: BTreeMap<CfgFunctionId, &'a crate::cfg::facts::CfgFunctionFact>,
...
impl<'a> SolverFactIndex<'a> {
    ...
    fn function_for_node(&self, node: CfgNodeId) -> Option<&'a crate::cfg::facts::CfgFunctionFact> {
        self.node_by_id
            .get(&node)
...
mod tests {
    ...
    use crate::domains::core::{ConstantDomain, ConstantLiteral, ReachabilityDomain};
    use crate::domains::lattice::TopReason;
    use crate::domains::store::{DomainMaterialization, DomainOutput};
    use crate::ids::{CallTargetId, MirBodyId, MirOpId, PlaceId, RefinedCallEdgeId};
    ...
    fn ide_solver_maps_constant_and_nilness_through_matched_call_and_return() {
        ...
        assert_eq!(
            ...
            Some(&crate::domains::core::NilnessDomain::NonNil)
        );
    }
    ...
    mod test_fixture {
        ...
        fn refined_call(
            ...
            RefinedCallEdgeFact {
                ...
                stable_key: polint_core::stable_key_for_test("refined:caller:callee"),
            }
        }
