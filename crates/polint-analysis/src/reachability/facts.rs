...
use crate::ids::{EntrypointId, ReachabilityRootId};
use polint_core::{FileId, FunctionId, Language, Span, StableKeyId, SymbolId};
...
pub struct ReachabilityRootFact {
    ...
    #[serde(skip)]
    pub id: ReachabilityRootId,
    pub kind: RootKind,
    pub language: Language,
    pub target_function: FunctionId,
    pub target_symbol: Option<SymbolId>,
    pub originating_entrypoint: Option<EntrypointId>,
    pub file: FileId,
    pub span: Span,
    pub precision: RootPrecision,
...
pub fn compute_reachability_root_stable_key(
    kind: RootKind,
    language: Language,
