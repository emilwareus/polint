...
fn validate_root(
    ...
    functions: &BTreeSet<polint_core::FunctionId>,
    symbols: &BTreeSet<polint_core::SymbolId>,
    files: &BTreeSet<polint_core::FileId>,
    entrypoints: &BTreeSet<crate::ids::EntrypointId>,
    stable_key: &str,
) {
...
mod tests {
    ...
    fn root(target: FunctionId, file: FileId, span: Span) -> ReachabilityRootFact {
        ReachabilityRootFact {
            ...
            stable_key: polint_core::stable_key_for_test(&compute_reachability_root_stable_key(
                RootKind::Main,
                Language::Go,
                "main.main",
                file,
    ...
    fn unresolved_configured_root_with_sentinel_ids_is_not_flagged_dangling() {
        ...
        let symbols: BTreeSet<polint_core::SymbolId> = BTreeSet::new();
