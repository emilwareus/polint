...
struct ReachabilityRootDigest<'a> {
    kind: crate::reachability::facts::RootKind,
    language: polint_core::Language,
    target_function: polint_core::FunctionId,
    target_symbol: Option<polint_core::SymbolId>,
    originating_entrypoint: Option<crate::ids::EntrypointId>,
    file: polint_core::FileId,
    span: &'a polint_core::Span,
    precision: crate::reachability::facts::RootPrecision,
    provenance: crate::reachability::facts::RootProvenance,
    status: crate::reachability::facts::RootStatus,
    provider_id: &'a str,
    stable_key: &'a str,
}
...
fn unresolved_configured_root_diagnostic(
    interner: &polint_core::StableKeyInterner,
    root: &crate::reachability::facts::ReachabilityRootFact,
) -> Diagnostic {
    Diagnostic::warning(
        "polint/internal",
        "<workspace>",
