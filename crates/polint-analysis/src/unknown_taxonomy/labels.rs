...
use crate::evidence::facts::EvidenceUnknownReason;
use crate::points_to::facts::{PointsToPrecision, PointsToStatus};
use crate::unknown_taxonomy::facts::{UnknownCategory, UnknownRow, UnknownRowInput};
...
pub fn call_precision_label(precision: crate::calls::facts::CallPrecision) -> &'static str {
    match precision {
        crate::calls::facts::CallPrecision::Exact => "exact",
        crate::calls::facts::CallPrecision::SetupAware => "setup_aware",
        crate::calls::facts::CallPrecision::Conservative => "conservative",
        crate::calls::facts::CallPrecision::Heuristic => "heuristic",
        crate::calls::facts::CallPrecision::Ambiguous => "ambiguous",
        crate::calls::facts::CallPrecision::Unknown => "unknown",
        crate::calls::facts::CallPrecision::Unsupported => "unsupported",
    }
}
