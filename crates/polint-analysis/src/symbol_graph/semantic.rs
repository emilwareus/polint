use polint_analysis_api::{FactFamily, SymbolNamespace, stable_key_from_parts};
use polint_core::{Diagnostic, DiagnosticRange as TextRange};
use polint_core::{FileId, Language, ModuleNodeId, PackageId, Span, StableKeyId, SymbolId};
...
impl CachedSemanticIndexOutput {
    ...
    pub fn into_output(self, interner: &polint_core::StableKeyInterner) -> SemanticIndexOutput {
        SemanticIndexOutput {
            scopes: self
                .scopes
                .into_iter()
...
impl SemanticIndexBuilder {
    ...
    pub fn finish(self, interner: &polint_core::StableKeyInterner) -> SemanticIndexOutput {
        SemanticIndexOutput {
...
impl ScopeFact {
    pub fn computed_stable_key(&self, interner: &polint_core::StableKeyInterner) -> StableKeyId {
        Self::stable_key_for(
            interner,
            self.language,
            &self.scope_path,
...
mod tests {
    use super::*;
    use polint_analysis_api::SymbolNamespace;
    use polint_core::{
...
mod alias_reexport_closure_tests {
    use super::*;
    use polint_analysis_api::SymbolNamespace;
    use polint_core::{FileId, Language, test_stable_key_interner};
