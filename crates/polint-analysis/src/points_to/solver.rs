...
use super::vars;
use crate::ids::{ObjectTokenId, PointsToSetId, PtVarId};
use crate::solver::budget::BudgetReason;
...
impl<'a> Solver<'a> {
    ...
    fn solve(&mut self, interner: &polint_core::StableKeyInterner) -> PointsToSolveResult {
        self.initialize();
    ...
    fn to_result(&self, interner: &polint_core::StableKeyInterner) -> PointsToSolveResult {
...
mod tests {
    use super::*;
    use crate::ids::{PointsToConstraintId, ValueFactId};
        ...
        let constraints = vec![
            ...
            constraint(
                ...
                PointsToConstraintKind::CallReturn {
                    dst: PtVarId(5),
                    value: crate::ids::ValueFactId(42),
                },
            ),
            constraint(
                "summary-flow",
