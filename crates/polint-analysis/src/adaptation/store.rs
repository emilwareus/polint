...
use crate::adaptation::facts::{
    AcceptedModelFact, LoadedModelFact, RejectedModelFact, RejectionReason,
};
use crate::adaptation::validate::{ValidationUniverse, validate_model_fact};
...
impl AdaptationModelStore {
    ...
    pub fn digest_parts(&self, interner: &polint_core::StableKeyInterner) -> Vec<String> {
