...
use crate::ids::{AliasAnswerId, ObjectTokenId, PtVarId};
...
pub struct AliasQueryIndex<'a> {
    access_paths: BTreeMap<crate::ids::AccessPathId, &'a AccessPathFact>,
...
mod tests {
    ...
    use crate::ids::{AccessPathId, PlaceId, PointsToSetId};
    ...
    fn zero_projection_access_path_aliases_its_base_place() {
        let paths = vec![AccessPathFact {
            ...
            stable_key: polint_core::stable_key_for_test("path:root"),
        }];
