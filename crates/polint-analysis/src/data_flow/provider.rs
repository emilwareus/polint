...
fn stable_fact_payload<T>(
    interner: &polint_core::StableKeyInterner,
    _stable_key: polint_core::StableKeyId,
    fact: &T,
) -> String
where
    T: Debug,
...
mod tests {
    ...
    fn entrypoint(file: FileId, function: FunctionId) -> EntrypointFact {
        EntrypointFact {
            ...
            stable_key: polint_core::stable_key_for_test("entrypoint:handler"),
        }
    }
    ...
    fn trust_boundary(file: FileId, function: FunctionId) -> TrustBoundaryFact {
        TrustBoundaryFact {
            ...
            entrypoint_stable_key: polint_core::stable_key_for_test("entrypoint:handler"),
            ...
            precision: EntrypointPrecision::ResolvedStatic,
            provider_id: "polint.entrypoints".to_string(),
            stable_key: polint_core::stable_key_for_test("trust-boundary:query"),
        }
    }
}
