...
use crate::calls::facts::{CallSiteFact, CallTargetStatus};
use crate::cfg::facts::{CfgEdgeFact, CfgFunctionFact, CfgNodeFact};
use crate::cfg::ids::CfgNodeId;
...
use crate::ids::{CallSiteId, DataFlowEdgeId, DataFlowNodeId, DataFlowPathId, RefinedCallEdgeId};
...
pub enum IcfgEdgeKind {
    Intra(crate::cfg::facts::CfgEdgeKind),
    Call(CallSiteId),
    Return(CallSiteId),
    CallToReturn(CallSiteId, crate::cfg::facts::CfgEdgeKind),
}
...
mod tests {
    ...
    use crate::cfg::ids::{BasicBlockId, CfgEdgeId, CfgFunctionId};
    use crate::data_flow::facts::{
        DataFlowAlgorithm, DataFlowConfidence, DataFlowNodeFact, DataFlowPrecision,
        DataFlowProvenance, DataFlowValidation,
    };
    use crate::data_flow::store::DataFlowOutput;
    use crate::ids::{CallTargetId, MirBodyId, MirOpId};
    ...
    fn refined_edge(id: u64) -> RefinedCallEdgeFact {
        RefinedCallEdgeFact {
            ...
            stable_key: polint_core::stable_key_for_test(&format!("refined:{id}")),
        }
    }
    ...
    fn cfg_edge(interner: &polint_core::StableKeyInterner, from: u64, to: u64) -> CfgEdgeFact {
        CfgEdgeFact {
            id: CfgEdgeId(0),
