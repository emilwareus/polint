            ...
            EvidenceOutput {
                ...
                unknowns: vec![
                    EvidenceUnknownFact {
                        ...
                        stable_key: polint_core::stable_key_for_test("unknown:dup"),
                    },
                    EvidenceUnknownFact {
                        bundle: None,
                        path: None,
    ...
    fn store_rejects_missing_bundle_path_slice_and_omitted_references() {
        let mut output = EvidenceOutput {
            ...
            bundles: vec![EvidenceBundleFact {
                ...
                diagnostic_stable_key: polint_core::stable_key_for_test("diagnostic:a"),
                ...
                replay_key: None,
                stable_key: polint_core::stable_key_for_test("bundle:a"),
            }],
            paths: vec![EvidencePathFact {
                ...
                stable_key: polint_core::stable_key_for_test("path:a"),
            }],
            slices: Vec::new(),
            unknowns: Vec::new(),
            omitted_regions: Vec::new(),
        ...
        assert!(
            EvidenceStore::from_output(output.clone(), &polint_core::test_stable_key_interner())
                .is_err()
        );
        ...
        assert!(
            EvidenceStore::from_output(output, &polint_core::test_stable_key_interner()).is_err()
        );
    }
