...
mod tests {
    ...
    use crate::points_to::facts::{PointsToPrecision, PointsToSetFact, PointsToStatus};
        ...
        db.replace_type_value_alias_facts(TypeValueAliasOutput {
            types: TypeOutput {
                types: vec![TypeFact {
                    ...
                    stable_key: polint_core::stable_key_for_test("type:fixture"),
                }],
                narrowed: Vec::new(),
            },
            values: ValueOutput {
                values: vec![ValueFact {
                    ...
                    value: crate::ids::AbstractValueId(0),
                    ...
                    stable_key: polint_core::stable_key_for_test("value:fixture"),
                }],
                allocations: vec![AllocationTokenFact {
                    ...
                    stable_key: polint_core::stable_key_for_test("allocation:fixture"),
                }],
            },
            access_paths: AccessPathOutput {
                access_paths: vec![AccessPathFact {
                    ...
                    stable_key: polint_core::stable_key_for_test("path:fixture"),
                }],
            },
            points_to: PointsToOutput {
                ...
                sets: vec![PointsToSetFact {
                    ...
                    stable_key: polint_core::stable_key_for_test("points-to:fixture"),
                }],
            },
            aliases: AliasOutput {
