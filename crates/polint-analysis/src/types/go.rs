...
pub fn derive_go_type_value_alias(db: &impl AnalysisHost) -> TypeValueAliasOutput {
...
fn type_fact_for_place(
    ...
    id: u64,
    place: &PlaceFact,
    body: Option<&crate::mir_body::MirBody>,
    ty: Option<&TypeShape>,
) -> TypeFact {
...
fn collect_values_for_operation(
    ...
    place_by_id: &BTreeMap<crate::ids::PlaceId, &PlaceFact>,
...
fn unsupported_type_fact(
    ...
    id: u64,
    subject: TypeSubject,
    unsupported: &crate::mir_op::UnsupportedSemanticFact,
    body: Option<&crate::mir_body::MirBody>,
    place: Option<crate::ids::PlaceId>,
) -> TypeFact {
...
trait PlaceRootBody {
    fn body(&self) -> Option<crate::ids::MirBodyId>;
}
...
mod tests {
    ...
    fn db_with_go_mir() -> LocalAnalysisDb {
        ...
        db.replace_semantic_mir(MirOutput {
            ...
            unsupported: vec![crate::mir_op::UnsupportedSemanticFact {
                id: crate::ids::UnsupportedId(0),
