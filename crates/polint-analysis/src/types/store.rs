...
use crate::ids::{NarrowedTypeId, PlaceId, TypeFactId, TypeSetId};
...
mod tests {
    use super::*;
    use crate::types::facts::{TypeConfidence, TypePhase, TypeProvenance, TypeShape, TypeSubject};
    ...
    fn type_output_remaps_type_set_references_after_sorting() {
        ...
        let output = TypeOutput {
            ...
            narrowed: vec![NarrowedTypeFact {
                ...
                precision: TypePrecision::Conservative,
                status: TypeStatus::Present,
                stable_key: polint_core::stable_key_for_test("narrowed:z"),
            }],
        }
        .normalized(&interner);
