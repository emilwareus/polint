...
impl CfgOutput {
    ...
    pub fn normalized(mut self, interner: &polint_core::StableKeyInterner) -> Self {
        self.functions
...
mod tests {
    use super::*;
    use crate::cfg::facts::{BasicBlockKind, CfgNodeKind, CfgPrecision, CfgStatus};
    ...
    fn block(interner: &polint_core::StableKeyInterner, stable_key: &str) -> BasicBlockFact {
        BasicBlockFact {
            id: BasicBlockId(1),
    ...
    fn empty_output_contains_no_rows() {
        let output = CfgOutput::empty().normalized(&polint_core::StableKeyInterner::default());
