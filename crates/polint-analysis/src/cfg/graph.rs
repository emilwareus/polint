...
use crate::cfg::ids::{BasicBlockId, CfgFunctionId};
...
impl<'a> CfgGraphIndex<'a> {
    pub fn new(interner: &'a polint_core::StableKeyInterner, output: &'a CfgOutput) -> Self {
...
impl<'a> CfgGraph<'a> {
    ...
    pub fn nodes(&self) -> Vec<&'a crate::cfg::facts::CfgNodeFact> {
        self.nodes.clone()
    }
...
mod tests {
    ...
    use crate::cfg::facts::{BasicBlockKind, CfgEdgeKind, CfgNodeKind, CfgView};
