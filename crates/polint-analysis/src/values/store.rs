...
use crate::ids::{AbstractValueId, AllocationTokenId, PlaceId, ValueFactId};
...
mod tests {
    use super::*;
    use crate::values::facts::{ValueKind, ValuePrecision, ValueProvenance, ValueSubject};

    fn value(id: u64, stable_key: &str) -> ValueFact {
        ValueFact {
            id: ValueFactId(id),
            subject: ValueSubject::Synthetic(stable_key.to_string()),
            value: crate::ids::AbstractValueId(id),
            kind: ValueKind::Null,
