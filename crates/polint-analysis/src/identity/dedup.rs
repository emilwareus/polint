...
use crate::identity::facts::{IdentityKind, IdentityRecord, LanguageTag, SignatureDigest};
...
pub fn record_sort_key(record: &IdentityRecord) -> SortKey {
    (
        record.language,
...
pub fn record_total_order_key(record: &IdentityRecord) -> TotalOrderKey {
...
pub fn dedup_identity_records(records: Vec<IdentityRecord>) -> Vec<IdentityRecord> {
