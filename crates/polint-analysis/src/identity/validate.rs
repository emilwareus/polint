...
use polint_analysis_api::{FunctionFact};
    ...
    fn validate_identity_reports_dangling_call_site_reference() {
        ...
        dangling.originating_call_site_id = Some(crate::ids::CallSiteId(42));
        dangling.stable_key = polint_core::stable_key_for_test(&compute_identity_stable_key(
    ...
    fn validate_identity_is_clean_for_well_formed_rows() {
        ...
        let stable_key = polint_core::stable_key_for_test(&compute_identity_stable_key(
