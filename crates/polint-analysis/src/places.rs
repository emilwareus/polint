...
use polint_core::{FileId, FunctionId, Language, StableKeyInterner};

pub use polint_ir::{PlaceFact, PlaceProjection, PlaceRoot, PlaceStatus, PlaceTypeFact};
...
mod tests {
    use super::*;
    use crate::ids::{CallSiteId, MirBodyId, PlaceId};
    use polint_core::{FileId, FunctionId, Language, SymbolId};
