...
use crate::analysis_neutral::adaptation::facts::{LoadedModelFact, RejectionReason};
...
impl ValidationUniverse {
    ...
    pub fn contains_source(&self, key: &str) -> bool {
        self.source_keys.contains(key)
    }

    pub fn contains_target(&self, key: &str) -> bool {
        self.target_keys.contains(key)
    }

    pub fn is_oracle_label(&self, key: &str) -> bool {
        self.oracle_labels.contains(key)
    }
}

pub fn validate_model_fact(
