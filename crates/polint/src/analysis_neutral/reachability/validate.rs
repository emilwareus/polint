...
use crate::analysis_neutral::reachability::facts::{ReachabilityRootFact, RootStatus};
...
pub fn validate_reachability(db: &impl AnalysisHost, diagnostics: &mut Vec<Diagnostic>) {
...
fn validate_root(
    ...
    functions: &BTreeSet<crate::internal_core::FunctionId>,
    symbols: &BTreeSet<crate::internal_core::SymbolId>,
    files: &BTreeSet<crate::internal_core::FileId>,
    entrypoints: &BTreeSet<crate::analysis_neutral::ids::EntrypointId>,
    stable_key: &str,
) {
...
mod tests {
    ...
    fn db_with_function() -> (LocalAnalysisDb, FileId, FunctionId) {
    ...
    fn unresolved_configured_root_with_sentinel_ids_is_not_flagged_dangling() {
        ...
        let symbols: BTreeSet<crate::internal_core::SymbolId> = BTreeSet::new();
        let files: BTreeSet<FileId> = BTreeSet::new();
        let entrypoints: BTreeSet<crate::analysis_neutral::ids::EntrypointId> = BTreeSet::new();
