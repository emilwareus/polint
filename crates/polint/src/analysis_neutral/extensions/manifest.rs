...
pub struct ExtensionManifest {
    ...
    pub providers: Vec<ExtensionProviderManifest>,
}
...
pub struct ExtensionProviderManifest {
    ...
    pub declared_reads: Vec<FactFamilyLabel>,
...
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
pub struct FactFamilyLabel(String);

impl ExtensionManifest {
    pub fn repo_local(extension_id: impl Into<String>) -> Result<Self, ManifestError> {
...
impl ExtensionProviderManifest {
    ...
    pub fn stable_provider_key(&self) -> String {
