...
pub const TYPE_VALUE_ALIAS_TYPE_FAMILY: &str = "type_value_alias.type";
pub const TYPE_VALUE_ALIAS_VALUE_FAMILY: &str = "type_value_alias.value";
pub const TYPE_VALUE_ALIAS_ALLOCATION_FAMILY: &str = "type_value_alias.allocation_token";
pub const TYPE_VALUE_ALIAS_ACCESS_PATH_FAMILY: &str = "type_value_alias.access_path";
pub const TYPE_VALUE_ALIAS_POINTS_TO_CONSTRAINT_FAMILY: &str =
    "type_value_alias.points_to_constraint";
pub const TYPE_VALUE_ALIAS_ALIAS_ANSWER_FAMILY: &str = "type_value_alias.alias_answer";
pub const REFINED_CALL_EDGE_FAMILY: &str = "refined_calls.edge";

pub const TYPE_VALUE_ALIAS_FACT_FAMILIES: &[&str] = &[
...
pub struct ExtensionFactCandidate {
    pub extension_id: String,
    pub provider_id: String,
    pub fact_family: String,
    pub stable_key: StableKeyId,
    pub binding_refs: Vec<String>,
    pub span: Option<ExtensionSpanRef>,
    pub precision: Option<ExtensionFactPrecision>,
...
pub enum ExtensionFactPrecision {
    Exact,
    SetupAware,
    Heuristic,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum ExtensionFactConfidence {
    High,
    Medium,
    Low,
}
...
pub fn is_type_value_alias_fact_family(family: &str) -> bool {
    TYPE_VALUE_ALIAS_FACT_FAMILIES.contains(&family)
}

pub fn has_required_type_value_alias_payload(candidate: &ExtensionFactCandidate) -> bool {
...
pub fn has_required_refined_call_payload(candidate: &ExtensionFactCandidate) -> bool {
...
mod tests {
    ...
    fn sink_output_normalization_is_independent_of_emission_order() {
        let first = ExtensionFactCandidate {
            ...
            stable_key: crate::internal_core::stable_key_for_test("route:/a"),
        ...
        assert_eq!(
            first.output_sort_key(&crate::internal_core::test_stable_key_interner()),
            (
                "demo",
                "routes",
                "extension.routes",
    ...
    fn type_value_alias_families_require_typed_payload_labels() {
        let mut candidate = ExtensionFactCandidate {
            ...
            stable_key: crate::internal_core::stable_key_for_test("alias:extension"),
    ...
    fn type_value_alias_payload_rejects_unknown_enums_and_raw_points_to_refs() {
        let mut candidate = ExtensionFactCandidate {
            ...
            stable_key: crate::internal_core::stable_key_for_test("pt:extension"),
            binding_refs: vec!["file:src/app.ts".to_string()],
            span: None,
            precision: Some(ExtensionFactPrecision::Heuristic),
            confidence: ExtensionFactConfidence::Medium,
    ...
    fn refined_call_payload_requires_site_target_algorithm_and_status() {
        let mut candidate = ExtensionFactCandidate {
            ...
            stable_key: crate::internal_core::stable_key_for_test("refined:extension"),
            binding_refs: vec!["file:src/app.ts".to_string()],
            span: None,
            precision: Some(ExtensionFactPrecision::Heuristic),
            confidence: ExtensionFactConfidence::Medium,
