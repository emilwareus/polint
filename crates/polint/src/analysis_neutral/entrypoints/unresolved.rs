...
use crate::analysis_neutral::entrypoints::facts::UnresolvedFrameworkFact;
...
mod tests {
    ...
    use crate::analysis_neutral::ids::UnresolvedFrameworkId;
    ...
    fn merge_combines_go_and_ts_facts() {
        ...
        let merged = merge_unresolved(&crate::internal_core::test_stable_key_interner(), go, ts);
