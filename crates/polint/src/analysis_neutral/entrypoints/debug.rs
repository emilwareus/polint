...
fn trigger_summary(
    metadata: &crate::analysis_neutral::entrypoints::facts::TriggerMetadata,
) -> String {
...
mod tests {
    ...
    use crate::internal_core::{FunctionId, Language, Span, SymbolId};
    ...
    fn test_db_populated() -> LocalAnalysisDb {
        ...
        let unresolved = UnresolvedFrameworkFact {
            ...
            provider_id: "polint.entrypoints".to_string(),
            stable_key: crate::internal_core::stable_key_for_test("unresolved:fastify:file"),
        };
