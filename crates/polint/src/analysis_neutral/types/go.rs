...
fn collect_values_for_operation(
    ...
    place_by_id: &BTreeMap<crate::analysis_neutral::ids::PlaceId, &PlaceFact>,
...
mod tests {
    ...
    use crate::internal_core::{FileId, FunctionId, Span};
    ...
    fn db_with_go_mir() -> LocalAnalysisDb {
        ...
        db.replace_semantic_mir(MirOutput {
            ...
            unsupported: vec![crate::analysis_neutral::mir_op::UnsupportedSemanticFact {
                id: crate::analysis_neutral::ids::UnsupportedId(0),
