...
struct TypeFactDigest<'a> {
    id: crate::analysis_neutral::ids::TypeFactId,
    subject: &'a super::facts::TypeSubject,
    type_set: crate::analysis_neutral::ids::TypeSetId,
    shape: &'a super::facts::TypeShape,
    phase: super::facts::TypePhase,
    language: crate::internal_core::Language,
    file: Option<crate::internal_core::FileId>,
    function: Option<crate::internal_core::FunctionId>,
    body: Option<crate::analysis_neutral::ids::MirBodyId>,
    place: Option<crate::analysis_neutral::ids::PlaceId>,
    cfg_block: Option<crate::analysis_neutral::cfg::ids::BasicBlockId>,
    operation: Option<crate::analysis_neutral::ids::MirOpId>,
...
struct NarrowedTypeFactDigest<'a> {
    id: crate::analysis_neutral::ids::NarrowedTypeId,
    place: crate::analysis_neutral::ids::PlaceId,
    type_set: crate::analysis_neutral::ids::TypeSetId,
    cfg_block: Option<crate::analysis_neutral::cfg::ids::BasicBlockId>,
    operation: Option<crate::analysis_neutral::ids::MirOpId>,
    predicate: Option<crate::analysis_neutral::ids::PlaceId>,
    evidence: &'a str,
    language: crate::internal_core::Language,
    file: Option<crate::internal_core::FileId>,
    function: Option<crate::internal_core::FunctionId>,
...
struct ValueFactDigest<'a> {
    id: crate::analysis_neutral::ids::ValueFactId,
    subject: &'a crate::analysis_neutral::values::facts::ValueSubject,
    value: crate::analysis_neutral::ids::AbstractValueId,
    kind: &'a crate::analysis_neutral::values::facts::ValueKind,
    language: crate::internal_core::Language,
    file: Option<crate::internal_core::FileId>,
    function: Option<crate::internal_core::FunctionId>,
    body: Option<crate::analysis_neutral::ids::MirBodyId>,
...
struct AllocationFactDigest<'a> {
    ...
    function: Option<crate::internal_core::FunctionId>,
    body: Option<crate::analysis_neutral::ids::MirBodyId>,
    source_place: Option<crate::analysis_neutral::ids::PlaceId>,
    source_operation: Option<crate::analysis_neutral::ids::MirOpId>,
    span: Option<&'a crate::internal_core::Span>,
    provenance: &'a crate::analysis_neutral::values::facts::ValueProvenance,
    stable_key: &'a str,
}
...
struct AccessPathFactDigest<'a> {
    ...
    base: crate::analysis_neutral::ids::PlaceId,
    projections: &'a [crate::analysis_neutral::access_paths::facts::AccessPathProjection],
    depth: u32,
    language: crate::internal_core::Language,
    file: Option<crate::internal_core::FileId>,
    function: Option<crate::internal_core::FunctionId>,
...
struct PointsToConstraintDigest<'a> {
    id: crate::analysis_neutral::ids::PointsToConstraintId,
    kind: &'a crate::analysis_neutral::points_to::facts::PointsToConstraintKind,
...
struct PointsToSetDigest<'a> {
    id: crate::analysis_neutral::ids::PointsToSetId,
    variable: crate::analysis_neutral::ids::PtVarId,
    objects: &'a [crate::analysis_neutral::ids::ObjectTokenId],
    status: crate::analysis_neutral::points_to::facts::PointsToStatus,
    precision: crate::analysis_neutral::points_to::facts::PointsToPrecision,
...
struct AliasAnswerDigest<'a> {
    id: crate::analysis_neutral::ids::AliasAnswerId,
    left: crate::analysis_neutral::aliases::facts::AliasOperand,
    right: crate::analysis_neutral::aliases::facts::AliasOperand,
