...
use crate::analysis_neutral::evidence::facts::{
    EvidenceEdgeFact, EvidenceEdgeKind, EvidenceStatus,
};
use crate::analysis_neutral::evidence::rank::{
    PathRankScore, compare_scores, rank_score_for_edges,
};
use crate::analysis_neutral::evidence::store::EvidenceStore;
use crate::analysis_neutral::ids::{CallSiteId, EvidenceEdgeId, EvidenceNodeId};
use crate::analysis_neutral::slicing::paths::{
        ...
        EvidenceStore::from_output(
            EvidenceOutput {
                ...
                edges: vec![EvidenceEdgeFact {
                    ...
                    stable_key: crate::internal_core::stable_key_for_test("edge:unknown-call"),
                }],
                bundles: Vec::new(),
                paths: Vec::new(),
                slices: Vec::new(),
