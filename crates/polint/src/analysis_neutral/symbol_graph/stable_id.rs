...
use crate::analysis_api::{SymbolKind, SymbolNamespace};
use crate::internal_core::{DefinitionId, Language, ReferenceId, Span, SymbolId};
...
mod symbol_graph_stable_ids {
    ...
    fn span(start_byte: u32, end_byte: u32) -> Span {
        Span::new(
            crate::internal_core::FileId::from_raw(7),
            start_byte,
            end_byte,
            3,
            5,
    ...
    fn stable_ids_do_not_include_transient_file_ids() {
        let first = Span::new(
            crate::internal_core::FileId::from_raw(1),
            10,
            16,
            3,
            5,
        ...
        let second = Span::new(
            crate::internal_core::FileId::from_raw(99),
            10,
            16,
            3,
            5,
