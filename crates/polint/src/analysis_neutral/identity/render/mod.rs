...
//!
//! Both renderers are pure `pub(crate)` functions over an [`crate::analysis_neutral::identity::facts::IdentityRecord`]
//! (plus, for Jelly, the borrowed [`crate::analysis_api::SourceFile`]). They are the
