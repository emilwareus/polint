...
pub struct IdentityRecordId(pub u64);
...
pub struct SignatureDigest(pub [u8; 16]);
...
pub struct IdentityRecord {
    pub id: IdentityRecordId,
    pub kind: IdentityKind,
    pub file_id: FileId,
    pub span: Span,
    pub language: LanguageTag,
    #[serde(with = "arc_str_serde")]
    pub package_or_module: Arc<str>,
    #[serde(with = "arc_str_serde")]
    pub container_path: Arc<str>,
    #[serde(with = "arc_str_serde")]
    pub display_name: Arc<str>,
    pub signature_digest: SignatureDigest,
    pub multiplicity: u32,
    pub stable_key: StableKeyId,
    pub originating_call_site_id: Option<CallSiteId>,
    pub originating_call_target_id: Option<CallTargetId>,
}
...
impl IdentityRecord {
    ...
    pub fn clone_with_multiplicity(&self, multiplicity: u32) -> Self {
        Self {
            multiplicity,
            ..self.clone()
        }
...
pub fn compute_identity_stable_key(
    kind: IdentityKind,
    language: LanguageTag,
    package_or_module: &str,
    container_path: &str,
