...
use crate::analysis_neutral::identity::dedup::record_sort_key;
use crate::analysis_neutral::identity::facts::{IdentityKind, IdentityRecord, LanguageTag};
...
pub struct IdentityProviderOutput {
...
impl IdentityProviderOutput {
    ...
    pub fn normalized(mut self, _interner: &StableKeyInterner) -> Self {
...
impl IdentityStore {
    ...
    pub fn records_for_file(&self, file: FileId) -> &[usize] {
        self.by_file.get(&file).map_or(&[], Vec::as_slice)
    }

    pub fn records_for_language(&self, language: LanguageTag) -> &[usize] {
        self.by_language.get(&language).map_or(&[], Vec::as_slice)
    }

    pub fn records_for_kind(&self, kind: IdentityKind) -> &[usize] {
...
mod tests {
    ...
    fn record(id: u64, file: u32, kind: IdentityKind, site: Option<u64>) -> IdentityRecord {
        ...
        IdentityRecord {
            ...
            multiplicity: 1,
            stable_key: crate::internal_core::stable_key_for_test(&compute_identity_stable_key(
                kind,
                language,
                "pkg",
                &format!("pkg.T{id}"),
