...
use crate::analysis_api::digest::{Digest, DigestKind};
use crate::analysis_api::provider::ProviderManifest;
...
fn sorted_schema_labels(schemas: &[crate::analysis_api::provider::SchemaVersion]) -> Vec<String> {
...
fn precision_ceiling_label(
    precision: crate::analysis_api::provider::PrecisionCeiling,
) -> &'static str {
    match precision {
        crate::analysis_api::provider::PrecisionCeiling::Exact => "exact",
        crate::analysis_api::provider::PrecisionCeiling::Syntax => "syntax",
        crate::analysis_api::provider::PrecisionCeiling::SetupAware => "setup_aware",
    }
}
