...
use crate::internal_core::{FileId, ModuleNodeId, StableKeyId, StableKeyInterner};
...
fn span_contains(
    container: &crate::internal_core::Span,
...
fn spans_overlap(left: &crate::internal_core::Span, right: &crate::internal_core::Span) -> bool {
