//! Test-only filesystem [`AnalysisCache`] fixture for TS adapter integration tests.
...
use crate::ts::hash::stable_hash;
use crate::ts::repo_fs;

const FILE_CACHE_VERSION: &str = "v1";
const CACHE_MAX_BYTES: u64 = 16 * 1_048_576;

/// Disk-backed analysis cache used only by `polint-ts` unit tests.
#[derive(Debug, Clone)]
