...
mod symbol_graph_ts_local_symbols {
    ...
    use crate::analysis_api::{DefinitionFact, SymbolFact, SymbolKind, SymbolNamespace, SymbolPrecision};
...
mod symbol_graph_ts_references {
    ...
    use crate::analysis_neutral::LocalAnalysisDb;
    use crate::analysis_neutral::symbol_graph::{model::SymbolGraphBuilder, SymbolGraphRequest};
    use crate::analysis_api::{ReferenceFact, ReferenceKind, SymbolFact, SymbolPrecision, SymbolResolutionStatus};
