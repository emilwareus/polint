...
use crate::go::semantic::store::{GO_SEMANTIC_STORE_FAMILY, GoSemanticStore};
use crate::go::syntax_store::{GO_SYNTAX_STORE_FAMILY, GoSyntaxStore};
...
impl FactDatabase for LocalFactDb {
    ...
    fn replace_symbol_facts(
        &mut self,
        _symbols: Vec<crate::analysis_api::SymbolFact>,
        _definitions: Vec<crate::analysis_api::DefinitionFact>,
        _references: Vec<crate::analysis_api::ReferenceFact>,
    ) {
    }
...
impl crate::analysis_neutral::AnalysisHost for LocalFactDb {}
