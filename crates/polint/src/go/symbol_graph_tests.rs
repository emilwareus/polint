...
mod semantic_conversion {
    ...
    fn derive(json: &[u8]) -> crate::analysis_neutral::symbol_graph::semantic::SemanticIndexOutput {
...
mod semantic_setup_missing {
    use crate::go::symbol_graph::*;
    use crate::analysis_neutral::symbol_graph::model::SymbolGraphBuilder;
    use crate::analysis_neutral::symbol_graph::semantic::{ResolutionStepKind, SemanticStatus};
    use crate::analysis_api::{ReferenceKind, SourceFile, SymbolResolutionStatus};
    use crate::internal_core::FileId;
    use crate::internal_core::Language;
    use std::collections::BTreeMap;
    use std::path::PathBuf;
  ...
  "errors":[]
        ...
        let mut builder = SymbolGraphBuilder::new(crate::internal_core::StableKeyInterner::default());
    ...
    fn analysis_db_with(file: SourceFile) -> crate::go::local_db::LocalFactDb {
