...
pub(crate) const POLINT_RULE_INSPECT_JSON_SCHEMA_V1_URL: &str = "https://raw.githubusercontent.com/oaiz-io/polint/main/docs/schemas/polint-rule-inspect-v1.json";
...
mod tests {
    ...
    fn inspect_rule_report_sorts_rules_and_uses_stable_top_level_fields() {
        ...
        let expected = r#"{"version":1,"schema":"https://raw.githubusercontent.com/oaiz-io/polint/main/docs/schemas/polint-rule-inspect-v1.json","tool":{"name":"polint","version":"0.0.0"},"rules":[{"rule_id":"local/alpha","description":"Alpha","severity":"info","sdk_version":"<SDK_VERSION>","fact_views":[],"capabilities":[],"options":{"common_fields":[{"name":"severity","configured":false},{"name":"files","configured":false},{"name":"allow_files","configured":false},{"name":"allow","configured":false},{"name":"max","configured":false},{"name":"deny","configured":false},{"name":"forbidden_imports","configured":false},{"name":"settings","configured":false}],"custom_settings":[],"typed_schema":null},"capability_support":[]},{"rule_id":"local/zeta","description":"Zeta","severity":"warn","sdk_version":"<SDK_VERSION>","fact_views":[{"view_type":"Imports","canonical_path":"polint::sdk::facts::Imports<'_>","capability":"imports","parameter_name":"imports"}],"capabilities":[{"name":"imports","derived_from_fact_views":["Imports"],"status":"requested"}],"options":{"common_fields":[{"name":"severity","configured":false},{"name":"files","configured":false},{"name":"allow_files","configured":false},{"name":"allow","configured":false},{"name":"max","configured":false},{"name":"deny","configured":false},{"name":"forbidden_imports","configured":false},{"name":"settings","configured":false}],"custom_settings":[],"typed_schema":null},"capability_support":[]}]}"#
