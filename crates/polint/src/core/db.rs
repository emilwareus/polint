...
use super::facts::{
    BranchObligation, CachedFileAnalysis, CachedFileFacts, ComplexityMetricFact, CoverageFact,
    DefinitionFact, DefinitionKind, FileMetricFact, FunctionFact, FunctionMetricFact, ImportFact,
    ...
    SymbolResolutionStatus, TS_JS_MODULE_FUNCTION_NAME, TestFact, TsClassFact, TsComponentFact,
    UnresolvedReason, is_synthetic_ts_js_module_function,
};
use super::ids::{
...
use super::metadata::*;
use super::review::{ChangedFile, ReviewChangeset};
use super::span::{Span, TextRange};
use super::{
    ...
    POLINT_DIRECT_SUMMARIES_PROVIDER_ID, SEMANTIC_MIR_PROVIDER_ID, SOURCE_PROVIDER_ID,
    SYMBOL_GRAPH_PROVIDER_ID, TS_SYNTAX_PROVIDER_ID,
};
...
mod tests {
    ...
    use crate::core::metadata::{
        lower_hex_u64, metadata_payload_digest, stable_parts,
        summary_event_payload_metadata_digest, summary_fact_payload_metadata_digest,
    };
    use crate::core::rule::{
        Rule, RuleCtx, RuleKind, RuleMeta, RuleOptions, RuleRegistry, line_col, rule_id_matches,
        run_rules, run_rules_with_capability_support, span_from_byte_range,
    };
