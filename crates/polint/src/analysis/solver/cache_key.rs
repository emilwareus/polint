        ...
        assert_eq!(
            ...
            Digest::from_parts(
                ...
                &[
                    ...
                    "budget.reason=points_to.max_objects_per_var",
                    "budget.reason=points_to.max_dynamic_vars",
                    ...
                    "budget.reason=object.max_objects_per_place",
                    "budget.reason=object.max_properties_per_object",
                    "budget.reason=object.max_tokens_per_property",
                    "budget.reason=object.max_computed_buckets_per_object",
                    ...
                    "budget.reason=adaptation.max_model_files",
                    "budget.reason=adaptation.max_model_facts",
                    "budget.reason=adaptation.max_expansions_per_model",
                    "budget.reason=adaptation.max_targets_per_source",
