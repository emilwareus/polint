...
pub(crate) struct DataFlowProviderParameters {
    pub(crate) local_mir: bool,
    pub(crate) direct_calls: bool,
    pub(crate) summary_projection: bool,
    pub(crate) extension_models: bool,
    pub(crate) max_query_depth: u32,
    pub(crate) max_path_count: u32,
}
...
pub(crate) fn data_flow_provider_parameter_digest() -> Digest {
    data_flow_provider_parameter_digest_for_settings(
        &DataFlowProviderParameters::deterministic_default(),
    )
}

pub(crate) fn data_flow_provider_parameter_digest_for_snapshot(
