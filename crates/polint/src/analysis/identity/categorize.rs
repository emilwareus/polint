...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum CategorizeReason {
...
pub(crate) fn category_for_unsupported(status: CallTargetStatus) -> Option<IdentityCategory> {
    match status {
...
pub(crate) fn category_for_wrong_identity(
