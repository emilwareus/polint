...
pub(crate) struct EntrypointOutput {
    ...
    pub(crate) trust_boundaries: Vec<TrustBoundaryFact>,
    pub(crate) dispatch_edges: Vec<FrameworkDispatchEdgeFact>,
...
pub(crate) struct EntrypointStore {
...
impl EntrypointStore {
    ...
    pub(crate) fn entrypoints(&self) -> &[EntrypointFact] {
        &self.output.entrypoints
    }

    pub(crate) fn trust_boundaries(&self) -> &[TrustBoundaryFact] {
        &self.output.trust_boundaries
    }

    pub(crate) fn dispatch_edges(&self) -> &[FrameworkDispatchEdgeFact] {
        &self.output.dispatch_edges
    }

    pub(crate) fn unresolved(&self) -> &[UnresolvedFrameworkFact] {
        &self.output.unresolved
    }

    pub(crate) fn output(&self) -> &EntrypointOutput {
        &self.output
    }
}
