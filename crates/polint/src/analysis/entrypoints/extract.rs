use crate::analysis::entrypoints::dispatch::derive_dispatch_edges;
use crate::analysis::entrypoints::recognizers_go::recognize_go_entrypoints;
use crate::analysis::entrypoints::recognizers_ts::recognize_ts_entrypoints;
use crate::analysis::entrypoints::store::EntrypointOutput;
use crate::analysis::entrypoints::trust_boundaries::derive_trust_boundaries;
use crate::analysis::entrypoints::unresolved::merge_unresolved;
