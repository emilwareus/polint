...
#[cfg(test)]
#[path = "tests_disabled.rs"]
mod tests;

pub use adapter::{
    analyze, analyze_files_with_plan_options_and_cache_stats, analyze_with_cache,
    analyze_with_options, analyze_with_plan_options, analyze_with_plan_options_and_cache_stats,
};
