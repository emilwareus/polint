...
mod tests {
    ...
    #[test]
    fn ts_inventory_survives_adversarially_deep_nesting() {
        // Deeply nested generated input must become a controlled parser limitation,
        // not a process-level stack overflow.
        ...
        // the default 2 MB test-thread stack), so we give the worker a generous stack.
        let result = std::thread::Builder::new()
            ...
            .spawn(|| {
                ...
                // The clean function comes first so inventory extraction can retain
                // useful facts before the pathological tail.
                ...
                // flags the pathologically deep tail.
