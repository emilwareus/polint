...
**Stack:** Rust 2024 with clap, serde, toml, ignore, globset, rayon, petgraph, tree-sitter-go, Oxc, and optional Wasmtime/WIT skeleton is the right stack for this product.
...
**Watch out for:** Avoid overbuilding plugins before SDK/rules, avoid misleading heuristic diagnostics, and enforce deterministic output despite parallelism.
