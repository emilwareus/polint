...
| `semantic_store_markers_do_not_leak_into_supported_public_surfaces` (`:487`) | 13 forbidden markers (`semantic-store type`, `rusqlite`, `PRAGMA user_version`, `SQLITE_OPEN_READ_WRITE`, `sqlite_row_id`, …, `:191-205`) appear in no `.rs`/`.md` under the public tree |
