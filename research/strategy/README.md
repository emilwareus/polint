...
- The plan is six phases over six quarters: instrument (P0), certify L4 (P1), persist summaries and make warm review real (P2), fix the scale envelope and ship the graph surface (P3), buy L5 selectively (P4), buy L6 selectively and publish head-to-head results (P5).
...
3. If you are deciding what to measure first, read report 04 sections 3 and 8. The P0 items in report 03 are the first three actions there.
...
- `.planning/ROADMAP.md` and `.planning/REQUIREMENTS.md` define v2.0; report 03 keeps the phases and moves them into the six-quarter plan.
