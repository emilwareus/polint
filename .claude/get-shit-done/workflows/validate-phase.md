...
```
Agent(
  prompt="Read /Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/templates/VALIDATION.md`
