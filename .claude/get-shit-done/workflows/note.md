...
- **Global scope**: `/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/notes/`)
...
2. Glob `/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/notes/` — works in any directory
