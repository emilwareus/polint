...
INSTALL_JS_GLOBAL="/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
