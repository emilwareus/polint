...
```bash
INIT=$(node "/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
