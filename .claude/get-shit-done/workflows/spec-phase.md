...
```bash
INIT=$(node "/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/get-shit-done/templates/spec.md.
