...
The keys live in `.claude/settings.json` (project) or `/Users/emilwareus/conductor/workspaces/exlint/islamabad/.claude/settings.json` (global) — **not** in `.planning/config.json`:
