...
fn print_provider_run() {
    println!(
        r#"{{"schema_version":"polint-extension-provider-run-v1","extension_id":"demo","provider_id":"refined","activation_status":"active","diagnostics":[],"facts":[{{"fact_family":"refined_calls.edge","stable_key":"extension:refined-ok","binding_refs":["file:src/app.ts"],"precision":"heuristic","confidence":"medium","evidence":["fixture-extension-model"],"payload_labels":["site=file_span:src/app.ts:29","synthetic_target=extension:model-target","algorithm=repo_model","status=resolved"]}},{{"fact_family":"refined_calls.edge","stable_key":"extension:refined-rejected","binding_refs":["file:src/app.ts"],"precision":"heuristic","confidence":"medium","evidence":["fixture-extension-model"],"payload_labels":["site=file_span:src/app.ts:29","algorithm=repo_model","status=resolved"]}}],"output_digest_inputs":["fixture=refined-calls-extension-model"]}}"#
    );
}
